...
def encrypt_file(shift1, shift2):
    try:
        with open(r'./raw_text.txt', 'r', encoding='utf-8') as f:
            text = f.read()

        encrypted = encrypt(text, shift1, shift2)

        with open(r'./encrypted_text.txt', 'w', encoding='utf-8') as f:
            f.write(encrypted)
...
def decrypt_file(shift1, shift2):
    try:
        with open(r'./encrypted_text.txt', 'r', encoding='utf-8') as f:
            encrypted = f.read()

        decrypted = decrypt(encrypted, shift1, shift2)

        with open(r'./decrypted_text.txt', 'w', encoding='utf-8') as f:
            f.write(decrypted)
...
def verify():
    try:
        ...
        with open(r'./decrypted_text.txt', 'r', encoding='utf-8') as f:
            decrypted = f.read()
